      ...
      <div className="rounded-2xl border bg-white p-6 md:p-8 shadow-sm">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="flex flex-col gap-3 w-full md:w-auto">
            <a href={`mailto:${PROFILE.email}`} className="inline-flex items-center justify-center gap-2 rounded-2xl bg-slate-900 px-4 py-2 text-sm font-medium bg-gradient-to-r from-blue-500 via-indigo-500 to-violet-600 text-white shadow hover:shadow-md transition">
